...
type AccountLeaseAction func(context.Context) (*proxygatewayv1.ProxyDynamicLease, error)

func RunAccountLeaseAction(ctx context.Context, locks LockManager, accountID string, action AccountLeaseAction) (*proxygatewayv1.ProxyDynamicLease, error) {
	if action == nil {
