...
export type ProxyGatewayIPFraudProviderRow =
  ReturnType<typeof proxyGatewayIPFraudEmptyRow>

export function proxyGatewayIPFraudRowFromSettings(
  item: NonNullable<ProxyGatewaySettings['ip_fraud_providers']>[number],
) {
  return {
    ...proxyGatewayIPFraudEmptyRow(),
...
export function proxyGatewayIPFraudRowFromDescriptor(
...
export function proxyGatewayUniqueIPFraudProviderID(
  base: string,
...
function proxyGatewayIPFraudEmptyRow() {
  return {
    provider_id: '',
    display_name: '',
